...
describe TasksController do
  ...
  describe "update" do
    before do
      Task.create(name: 'Cake', description: "finish the leftover cake in the fridge", completed_at: "2020-10-29T12:00:00Z")
    end
    ...
    let (:new_task) {
      {
          task: {
              name: "Buy eggs",
              description: "get eggs from Costco",
              completed_at: "2020-10-30T17:00:00Z",
          },
      }
    }
    ...
    it "will redirect to the root page if given an invalid id" do
      expect {
        patch task_path(-1), params: new_task
      }.wont_change 'Task.count'
